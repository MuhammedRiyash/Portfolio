    ...
    <div>
      ...
      <div className="mx-2">
        <form
          ...
          action="https://formspree.io/f/xgokrkbd"
          method="POST"
        >
          <input
            type="text"
          ...
          <textarea
            name="message"
            placeholder="Message*"
            className={`${commonClass} min-h-[80px]`}
            required
          />
          <button
            type="submit"
            className="btn gap-3 max-lg:mx-auto btn-primary rounded-xl mt-5 text-[13px] md:text-[16px] w-fit font-semibold lg:mt-16 p-2 md:px-4"
          >
            Submit {telegramSVG}
          </button>
        </form>
