...
const addressData = [
  {
    icon: faLocationDot,
    title: "Address",
    description: "1/131 mosque street,nemili taluk,ranipet district",
  },
  {
    icon: faEnvelope,
    title: "My Email",
    description: "www.thisismd.riyash@gmail.com",
  },
  {
    icon: faPhone,
    title: "Call Me Now",
    description: "+91 7094836267",
  },
];

const Contact = () => {
  return (
    <div className="relative -bottom-15 -mt-15 z-10 px-2 mb-20 md:mb-32">
      <div
      ...
      >
        <div className="flex flex-col-reverse lg:gap-5 xl:gap-25.75 lg:flex-row justify-between">
          <div>
            ...
            <div className="my-8.75 grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-5">
              {addressData.map((item, index) => (
                <Address item={item} key={index} />
              ))}
            </div>
            <div className="w-full max-lg:text-center max-md:mb-4 mt-10">
              <SocialMedia />
            </div>
          </div>
          <div className="w-full overflow-visible py-6.5">
