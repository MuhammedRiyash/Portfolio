      ...
      <div className="navbar flex justify-between mx-auto content">
        <div className="flex items-center justify-between">
          <div className="dropdown">
            ...
            <ul
              tabIndex={0}
              className={`menu menu-lg dropdown-content rounded-box z-1 mt-3 w-52 p-2 shadow font-semibold flex-nowrap bg-white text-black`}
            >
              {menu}
            </ul>
          </div>
          ...
          >
            <img src={logo} alt="Muhammed Riyash Logo" className="h-16 sm:h-22 object-contain" />
          </Link>
        </div>
        ...
        <div className="lg:flex items-center">
          ...
          <p className="">
            <Link
              className="btn btn-sm xs:btn-md btn-primary px-8 rounded-full"
              href="#contact"
              to={`contact`}
              smooth={true}
              duration={900}
